...
2. **Next product decision:** P0-04 authoritative data and persistence. Applies to the native runtime (SQLite is a candidate, not a decision). Cleanup of the current adapter may not select the production technology or authority model.
