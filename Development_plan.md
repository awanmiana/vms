...
2. **Next product decision:** ~~P0-04 authoritative data and persistence~~ **decided 2026-07-26** — the owner selected the embedded, standalone-first direction (SQLite as the local authority behind the C0-03 adapter contract; central/cloud/sync deferred to P1-10). Building as native increment 5 per `native/persistence-P0-04-proposal.md`. The subsequent gates queued by the owner are the connection broker + credential store (DPAPI), then the Phase-4 recording backend.
